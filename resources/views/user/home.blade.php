...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav align-items-center justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-3" href="#cars">Cars</a>
                        </li>
                        <li class="nav-item">
                        ...
                        {{-- @if (isset($user))
                            <a class="fw-bold text-capitalize fs-5 px-3 py-2"
        ...
        {{-- <section id="search position-absolute top-50 start-50 translate-middle">
            <div class="container search-block p-5">
                <form class="row">
                    <div class="row justify-content-center">
                        <div class="col-6 col-md-6 col-lg-6 mt-4 mb-4 mt-lg-0 ">
                            <label for="vehicle" class="label-style text-capitalize form-label text-white">Vehicle
                                type</label>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-3 mt-4 mt-lg-0">
                            <label for="location" class="label-style text-capitalize form-label text-white">Picking up
                                location</label>
                        ...
                        <div class="col-12 col-md-6 col-lg-3 mt-4 mt-lg-0">
                            <label for="location" class="label-style text-capitalize form-label text-white">Drop off
                                location</label>
                        ...
                        <div class="col-12 col-md-6 col-lg-3 mt-4 mt-lg-0">
                            <label for="pick-up-date"
                                class="label-style text-capitalize form-label text-white">Picking up
                                date</label>
                            <input type="datetime-local" class="form-control p-3" id="pick-up-date" />
                        </div>

                        <div class="col-12 col-md-6 col-lg-3 mt-4 mt-lg-0">
                            <label for="return-date"
                                class="label-style text-capitalize form-label text-white">Returning
                                date</label>
                            <input type="datetime-local" class="form-control p-3" id="return-date" />
                        </div>
                    </div>
                ...
                <div class="d-grid gap-2 mt-4 mb-5">
                    <button class="btn btn-primary" type="button">Book your car</button>
                </div>
            </div>
        </section> --}}
    </section>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="post pt-5 pb-3">
                        <div class="image-zoom">
                            <a href="blog-single.html" class="blog-img"><img src="images/rental-1.jpg"
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-post pt-5 pb-3">
                        <div class="image-zoom">
                            <a href="blog-single.html" class="blog-img"><img src="images/rental-2.jpg"
                                    alt="" class="img-fluid" /></a>
                        </div>
                        <div class="text-center text-dark text-uppercase">
                            <a href="#">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-post pt-5 pb-3">
                        <div class="image-zoom">
                            <a href="blog-single.html" class="blog-img"><img src="images/rental-3.jpg"
                                    alt="" class="img-fluid" /></a>
                        </div>
                        <div class="text-center text-dark text-uppercase">
                            <a href="#">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-post pt-5 pb-3">
                        <div class="image-zoom">
                            <a href="blog-single.html" class="blog-img"><img src="images/rental-4.jpg"
                                    class="img-fluid" /></a>
                        </div>
                        <div class="text-center text-dark text-uppercase">
                            <a href="#">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-post pt-5 pb-3">
                        <div class="image-zoom">
                            <a href="blog-single.html" class="blog-img"><img src="images/rental-5.jpg"
                                    alt="" class="img-fluid" /></a>
                        </div>
                        <div class="text-center text-dark text-uppercase">
                            <a href="#">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="blog-post pt-5 pb-3">
                        <div class="image-zoom">
                            <a href="blog-single.html" class="blog-img"><img src="images/rental-6.jpg"
                                    alt="" class="img-fluid" /></a>
                        </div>
                        <div class="text-center text-dark text-uppercase">
                            <a href="#">
                    ...
                    <a href="images/type1.jpg" title="Life" class="image-link"><img src="images/type1.jpg"
                        ...
                        <div class="types mt-2">
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="#" class="btn-underline mt-2 mb-2 text-uppercase fw-bold"
    ...
    <div class="container py-5" id="cars">
        <div class="row pt-5 ">
            <div class="col-12">
                <h3 class="text-uppercase text-center text-dark mb-4">
                    Choose our top rated car
                </h3>
            </div>
            @foreach ($cars as $car)
                <div class="col-md-4 ">
                    <div class="card shadow-lg mb-4 p-2">
                        <a href="{{ $car->image }}" title="Life" class="image-link"><img
                                src="{{ $car->image }}" class="post-image img-fluid" />
                            <div class="types mt-2">
                                <h5 class="text-center text-uppercase m-0 text-dark">
                                    {{ $car->car_name }}
                                </h5>
                                <p class="text-center m-0 p-0">Daily Rate <b> {{$car->daily_rent}} BDT</b></p>

                                <div class="d-flex justify-content-center">
                                    <a href="{{ route('single-car', ['id' => $car->id]) }}" class="btn-underline mt-2 mb-2 text-uppercase fw-bold"
                                        style="font-size: 14px">Rent now</a>
                                </div>
                            </div>
                        </a>
            ...
            <div class="pagination-container d-flex justify-content-center">
                {{ $cars->links('pagination::bootstrap-5') }}  <!-- or pagination::bootstrap-5 for Bootstrap 5 -->
            </div>
        </div>
    </div>
    ...
    <section id="blog" class="padding-small pt-0">
        ...
        <div class="container">
            <div class="row g-3">
                <div class="col-lg-4 col-12"><a href="#"><img src="images/blog1.jpg" alt=""
                            class="img-fluid">
                        <p class="text-secondary mb-0"> Feb 22, 2023 / Tips</p>
                        <h4>Safest car rental services in 2023</h4>
                    </a></div>

                <div class="col-lg-4 col-12"><a href="#"><img src="images/blog2.jpg" alt=""
                            class="img-fluid">
                        <p class="text-secondary mb-0"> Feb 22, 2023 / Tips</p>
                        <h4>Best car collection in the world</h4>
                    </a></div>

                <div class="col-lg-4 col-12"><a href="#"><img src="images/blog3.jpg" alt=""
                            class="img-fluid">
                        <p class="text-secondary mb-0"> Feb 22, 2023 / Information</p>
                        <h4>Which car is the best for travel</h4>
                    </a></div>
            </div>
            <div class="blog-btn text-center mt-5"><button class="btn btn-dark rounded-0 text-uppercase"> Read
                    blogs</button></div>
        </div>
    </section>
       <!-- contact info section start  -->
       <section id="contact">
        <div class="position-relative jarallax"
            style="
        ...
        ">
            <div class="container">
                <div class="hero-content text-center position-absolute start-50 top-50 translate-middle">
                    ...
                    <h4 class="fw-medium"><a href="#" class="text-white text-decoration-underline">Call us (99)
                            124 1242 12</a>
