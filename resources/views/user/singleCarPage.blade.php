                ...
                <div class="row">
                    <div class="card shadow-md">
                        <div class="card-body">
                            ...
                            <img id="img" src="{{ asset($car->image) }}" alt="" class="img-fluid">
                            <h5 id="name" class="card-title pt-3 ">Car Name: {{ $car->car_name }}</h5>
                            <p id="model" class="card-title">Model: {{ $car->model }}</p>
                            <p id="price" class="card-text fw-bold fs-5 text-info"><span id="unitPrice">Price Per
                                    Day: {{ $car->daily_rent }}</span></p>
                            <p id="description" class="card-text">{{ $car->description }}</p>
                        </div>
                    </div>
                </div>
            </div>
